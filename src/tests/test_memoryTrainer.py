...
class TestMemoryTrainer(TestCase):
    ...
    def test_persist_load(self):
        ...
        self.trainer.upsert_record('1', 1, datetime(2019, 1, 4), StatusEnum.NOT_STARTED)
        self.trainer.upsert_record('2', 1, datetime(2019, 2, 1), StatusEnum.FAIL)
